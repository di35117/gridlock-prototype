      ...
      <div className="p-3 relative z-10">
        <div className="flex items-center justify-between border-b border-red-500/30 pb-2 mb-2">
          <div className="flex items-center space-x-2 text-red-400">
            ...
            <h4 className="text-xs font-black tracking-widest font-mono">
              COMPOUND THREAT COEFFICIENT DETECTED
            </h4>
          </div>
          ...
          {isHighSeverity && (
            <div className="flex items-start space-x-2 text-sm bg-red-950/40 p-2 rounded border border-red-900/50">
              ...
              <p className="text-gray-300 font-mono text-xs">
                ...
                Gridlock expansion score exceeded limits. Commit immediate
                manpower deployment to prevent network cascading choke.
              </p>
            </div>
          )}
        </div>
